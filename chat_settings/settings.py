"""
Django settings for shex project.
...
SECRET_KEY = 'django-insecure-5w(9g=n&ae(239%!ub#^w4aoi4som*oivb1kg2%ta^1755*nb0'
...
ROOT_URLCONF = 'chat_settings.urls'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'client.auth.BearerAuthentication',
    ),
...
WSGI_APPLICATION = 'chat_settings.wsgi.application'
